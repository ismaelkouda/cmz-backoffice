...
```
cd existing_repo
git remote add origin https://gitlab.imako.digital/imako-frontend/env-client-psim-frontend-tenant.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.imako.digital/imako-frontend/env-client-psim-frontend-tenant/-/settings/integrations)
