...
import { FiberConstructorSelectUseCase } from '@pages/coverage-areas/application/use-cases/fiber-constructor/fiber-constructor-select.use-case';
...
export class FiberConstructorSelectFacade extends ArrayBaseFacade<
    SelectOption,
    void
> {
