...
export class LegalNoticeRepositoryImpl implements LegalNoticeRepository {
    ...
    fetchLegalNotice(filter: LegalNoticeFilter, page: string): Observable<Paginate<LegalNoticeEntity>> {
    ...
    getLegalNoticeById(id: string): Observable<GetLegalNoticeByIdEntity> {
        return this.api.getLegalNoticeById(id).pipe(
            map((dto) => this.getLegalNoticeByIdMapper.toEntity(dto))
        );
    }

    createLegalNotice(params: FormData): Observable<SimpleResponseDto<void>> {
        return this.api.createLegalNotice(params).pipe(
            catchError((error: unknown) =>
                throwError(
                    () =>
                        new Error(
    ...
    updateLegalNotice(id: string, params: FormData): Observable<SimpleResponseDto<void>> {
        return this.api.updateLegalNotice(id, params).pipe(
            catchError((error: unknown) =>
                throwError(
                    () =>
                        new Error(
    ...
    deleteLegalNotice(id: string): Observable<SimpleResponseDto<void>> {
        return this.api.deleteLegalNotice(id).pipe(
            catchError((error: unknown) =>
                throwError(
                    () =>
                        new Error(
    ...
    publishLegalNotice(id: string): Observable<SimpleResponseDto<void>> {
        return this.api.publishLegalNotice(id).pipe(
            catchError((error: unknown) =>
                throwError(
                    () =>
                        new Error(
    ...
    unpublishLegalNotice(id: string): Observable<SimpleResponseDto<void>> {
        return this.api.unpublishLegalNotice(id).pipe(
            catchError((error: unknown) =>
                throwError(
                    () =>
                        new Error(
