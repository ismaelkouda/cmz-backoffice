...
import { GetTermsUseByIdItemDto, GetTermsUseByIdResponseDto } from '@presentation/pages/content-management/core/application/dtos/terms-use/get-terms-use-by-id-response.dto';
...
export class GetTermsUseByIdMapper extends SimpleResponseMapper<GetTermsUseByIdEntity, GetTermsUseByIdItemDto> {
