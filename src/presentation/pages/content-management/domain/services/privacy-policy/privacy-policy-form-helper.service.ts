...
export class PrivacyPolicyFormHelperService {
    ...
    getSweetAlertTitle(isEditMode: boolean): string {
        return isEditMode
            ? 'CONTENT_MANAGEMENT.PRIVACY_POLICY.SWEET_ALERT.TITLE_UPDATE'
            : 'CONTENT_MANAGEMENT.PRIVACY_POLICY.SWEET_ALERT.TITLE_CREATE';
    }

    getSweetAlertMessage(isEditMode: boolean): string {
        return isEditMode
            ? 'CONTENT_MANAGEMENT.PRIVACY_POLICY.SWEET_ALERT.MESSAGE_UPDATE'
            : 'CONTENT_MANAGEMENT.PRIVACY_POLICY.SWEET_ALERT.MESSAGE_CREATE';
    }
}
