...
export class NewsPageComponent implements OnInit {
    ...
    public readonly facade = inject(NewsFacade);
    ...
    readonly form = this.fb.group<NewsFilterControl>({
    ...
    ngOnInit(): void {
        ...
        this.translate.onLangChange
            ...
            .subscribe(() => {
                this.title.setTitle(
                    this.t('CONTENT_MANAGEMENT.NEWS.PAGE_TITLE')
                );
            });
    }
    ...
    public onNavigateToForm(event: {
        ...
        const queryParams = event.item
            ...
            : { ref: event.ref };
        this.router.navigate([NEWS_FORM], {
