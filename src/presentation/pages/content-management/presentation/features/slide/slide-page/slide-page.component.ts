...
export class SlidePageComponent implements OnInit {
    ...
    public onDeleteClicked(item: SlideEntity): void {
        ...
        SweetAlert.fire({
            ...SWEET_ALERT_PARAMS,
            title: this.t('CONTENT_MANAGEMENT.SLIDE.SWEET_ALERT.TITLE_DELETE'),
            text: `${this.t('CONTENT_MANAGEMENT.SLIDE.SWEET_ALERT.MESSAGE_DELETE')}`,
    ...
    public onEnableClicked(item: SlideEntity): void {
        ...
        SweetAlert.fire({
            ...SWEET_ALERT_PARAMS,
            title: this.t('CONTENT_MANAGEMENT.SLIDE.SWEET_ALERT.TITLE_ENABLE'),
            text: `${this.t('CONTENT_MANAGEMENT.SLIDE.SWEET_ALERT.MESSAGE_ENABLE')}`,
            backdrop: false,
            confirmButtonText: this.t('COMMON.CONFIRM'),
            cancelButtonText: this.t('COMMON.CANCEL'),
        }).then((result) => {
    ...
    public onDisableClicked(item: SlideEntity): void {
        ...
        SweetAlert.fire({
            ...SWEET_ALERT_PARAMS,
            title: this.t('CONTENT_MANAGEMENT.SLIDE.SWEET_ALERT.TITLE_DISABLE'),
            text: `${this.t('CONTENT_MANAGEMENT.SLIDE.SWEET_ALERT.MESSAGE_DISABLE')}`,
            confirmButtonText: this.t('COMMON.CONFIRM'),
            cancelButtonText: this.t('COMMON.CANCEL'),
        }).then((result) => {
            if (result.isConfirmed) {
