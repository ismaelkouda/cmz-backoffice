...
export class SlidePageComponent implements OnInit {
    ...
    public readonly facade = inject(SlideFacade);
    ...
    public readonly tableConfig = SLIDE_TABLE;
    ...
    readonly form = this.fb.group<SlideFilterControl>({
    ...
    ngOnInit(): void {
        ...
        this.translate.onLangChange
            ...
            .subscribe(() => {
                this.title.setTitle(
                    this.t('CONTENT_MANAGEMENT.SLIDE.PAGE_TITLE')
                );
            });
    }
    ...
    public onNavigateToForm(event: {
        ...
        const queryParams = event.item
            ...
            : { ref: event.ref };
        this.router.navigate([SLIDE_FORM], {
    ...
    public onDeleteClicked(item: SlideEntity): void {
        ...
        SweetAlert.fire({
            ...SWEET_ALERT_PARAMS,
            title: this.t('CONTENT_MANAGEMENT.SLIDE.SWEET_ALERT.TITLE.DELETE'),
            text: `${this.t('CONTENT_MANAGEMENT.SLIDE.SWEET_ALERT.MESSAGE.DELETE')}`,
    ...
    public onEnableClicked(item: SlideEntity): void {
        ...
        SweetAlert.fire({
            ...SWEET_ALERT_PARAMS,
            title: this.t('CONTENT_MANAGEMENT.SLIDE.SWEET_ALERT.TITLE.ENABLE'),
            text: `${this.t('CONTENT_MANAGEMENT.SLIDE.SWEET_ALERT.MESSAGE.ENABLE')}`,
            backdrop: false,
            confirmButtonText: this.t('COMMON.CONFIRM'),
            cancelButtonText: this.t('COMMON.CANCEL'),
        }).then((result) => {
    ...
    public onDisableClicked(item: SlideEntity): void {
        ...
        SweetAlert.fire({
            ...SWEET_ALERT_PARAMS,
            title: this.t('CONTENT_MANAGEMENT.SLIDE.SWEET_ALERT.TITLE.DISABLE'),
            text: `${this.t('CONTENT_MANAGEMENT.SLIDE.SWEET_ALERT.MESSAGE.DISABLE')}`,
            confirmButtonText: this.t('COMMON.CONFIRM'),
            cancelButtonText: this.t('COMMON.CANCEL'),
        }).then((result) => {
            if (result.isConfirmed) {
