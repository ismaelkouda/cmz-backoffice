...
export class SlideComponent implements OnInit, OnDestroy {
  ...
  public subModule: string = this.translate.instant('CONTENT_MANAGEMENT.SLIDE.LABEL');
  public slide$: Observable<SlideEntity[]> = this.slideFacade.slide$;
  public pagination$: Observable<Paginate<SlideEntity>> = this.slideFacade.pagination$;
  ...
  private setupMeta(): void {
    this.title.setTitle(this.translate.instant('CONTENT_MANAGEMENT.SLIDE.TITLE'));
  }
