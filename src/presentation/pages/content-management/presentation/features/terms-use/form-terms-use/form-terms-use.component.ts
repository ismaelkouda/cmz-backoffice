...
@Component({
    ...
    templateUrl: './form-terms-use.component.html',
    styleUrls: ['./form-terms-use.component.scss'],
    standalone: true,
    imports: [
        CommonModule,
        TranslateModule,
...
export class FormTermsUseComponent implements OnInit, OnDestroy {
    ...
    onSubmit(): void {
        ...
        if (this.isEditMode && this.currentId) {
            this.termsUseFacade.update(this.currentId, formData).subscribe({
                next: () => {
                    this.onCancel();
                },
            });
        } else {
            this.termsUseFacade.create(formData).subscribe({
                next: () => {
                    this.onCancel();
                },
            });
