...
export class TermsUsePageComponent implements OnInit {
    ...
    public onDeleteClicked(item: TermsUseEntity): void {
        ...
        SweetAlert.fire({
            ...SWEET_ALERT_PARAMS,
            title: this.t(
                'CONTENT_MANAGEMENT.TERMS_USE.SWEET_ALERT.TITLE.DELETE'
            ),
            text: `${this.t('CONTENT_MANAGEMENT.TERMS_USE.SWEET_ALERT.MESSAGE.DELETE')}`,
    ...
    public onEnableClicked(item: TermsUseEntity): void {
        ...
        SweetAlert.fire({
            ...SWEET_ALERT_PARAMS,
            title: this.t(
                'CONTENT_MANAGEMENT.TERMS_USE.SWEET_ALERT.TITLE.ENABLE'
            ),
            text: `${this.t('CONTENT_MANAGEMENT.TERMS_USE.SWEET_ALERT.MESSAGE.ENABLE')}`,
            backdrop: false,
            confirmButtonText: this.t('COMMON.CONFIRM'),
            cancelButtonText: this.t('COMMON.CANCEL'),
        }).then((result) => {
    ...
    public onDisableClicked(item: TermsUseEntity): void {
        ...
        SweetAlert.fire({
            ...SWEET_ALERT_PARAMS,
            title: this.t(
                'CONTENT_MANAGEMENT.TERMS_USE.SWEET_ALERT.TITLE.DISABLE'
            ),
            text: `${this.t('CONTENT_MANAGEMENT.TERMS_USE.SWEET_ALERT.MESSAGE.DISABLE')}`,
            confirmButtonText: this.t('COMMON.CONFIRM'),
            cancelButtonText: this.t('COMMON.CANCEL'),
        }).then((result) => {
            if (result.isConfirmed) {
