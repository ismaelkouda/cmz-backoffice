...
export class TermsUseComponent implements OnInit {
  ...
  public subModule: string = this.translate.instant('CONTENT_MANAGEMENT.TERMS_USE.LABEL');
  public termsUse$: Observable<TermsUseEntity[]> = this.termsUseFacade.termsUse$;
  public pagination$: Observable<Paginate<TermsUseEntity>> = this.termsUseFacade.pagination$;
  ...
  private setupMeta(): void {
    this.title.setTitle(this.translate.instant('CONTENT_MANAGEMENT.TERMS_USE.TITLE'));
  }
