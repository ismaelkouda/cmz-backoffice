  ...
  template: `
    <div ngbDropdown class="action-dropdown" container="body">
      ...
      >
        ...
        >
          <div class="action-dropdown__item-content">
            <i class="pi pi-pencil action-dropdown__icon action-dropdown__icon--edit"></i>
            <span class="action-dropdown__label">{{ 'COMMON.EDIT' | translate }}</span>
          </div>
        </button>
        ...
        @if (status() === actionDropdown.INACTIVE) {
          ...
          >
            <div class="action-dropdown__item-content">
              <i class="pi pi-check action-dropdown__icon action-dropdown__icon--enable"></i>
              <span class="action-dropdown__label"> {{ 'COMMON.ENABLE' | translate }}</span>
            </div>
          </button>
        }
        ...
        @if (status() === actionDropdown.UNPUBLISHED) {
          ...
          >
            <div class="action-dropdown__item-content">
              <i class="pi pi-check action-dropdown__icon action-dropdown__icon--enable"></i>
              <span class="action-dropdown__label"> {{ 'COMMON.PUBLISH' | translate }}</span>
            </div>
          </button>
        }
        ...
        @if (status() === actionDropdown.ACTIVE) {
          ...
          >
            <div class="action-dropdown__item-content">
              <i class="pi pi-times action-dropdown__icon action-dropdown__icon--disable"></i>
              <span class="action-dropdown__label">{{ 'COMMON.DISABLE' | translate }}</span>
            </div>
          </button>
        }
        ...
        @if (status() === actionDropdown.PUBLISHED) {
          ...
          >
            <div class="action-dropdown__item-content">
              <i class="pi pi-times action-dropdown__icon action-dropdown__icon--disable"></i>
              <span class="action-dropdown__label">{{ 'COMMON.UNPUBLISH' | translate }}</span>
            </div>
          </button>
        }
        ...
        >
          <div class="action-dropdown__item-content">
            <i class="pi pi-trash action-dropdown__icon action-dropdown__icon--danger"></i>
            <span class="action-dropdown__label">{{ 'COMMON.DELETE' | translate }}</span>
          </div>
        </button>
      </div>
    </div>
