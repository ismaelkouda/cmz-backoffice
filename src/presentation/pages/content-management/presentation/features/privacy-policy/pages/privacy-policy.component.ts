...
export class PrivacyPolicyComponent implements OnInit {
  ...
  public subModule: string = this.translate.instant('CONTENT_MANAGEMENT.PRIVACY_POLICY.LABEL');
  public privacyPolicy$: Observable<PrivacyPolicyEntity[]> = this.privacyPolicyFacade.privacyPolicy$;
  public pagination$: Observable<Paginate<PrivacyPolicyEntity>> = this.privacyPolicyFacade.pagination$;
  ...
  private setupMeta(): void {
    this.title.setTitle(this.translate.instant('CONTENT_MANAGEMENT.PRIVACY_POLICY.TITLE'));
  }
