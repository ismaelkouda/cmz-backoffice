...
export class LegalNoticeComponent implements OnInit {
  ...
  public subModule: string = this.translate.instant('CONTENT_MANAGEMENT.LEGAL_NOTICE.LABEL');
  public legalNotice$: Observable<LegalNoticeEntity[]> = this.legalNoticeFacade.legalNotice$;
  public pagination$: Observable<Paginate<LegalNoticeEntity>> = this.legalNoticeFacade.pagination$;
  ...
  private setupMeta(): void {
    this.title.setTitle(this.translate.instant('CONTENT_MANAGEMENT.LEGAL_NOTICE.TITLE'));
  }
