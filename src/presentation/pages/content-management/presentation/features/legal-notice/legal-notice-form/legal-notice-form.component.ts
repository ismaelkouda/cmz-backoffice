...
import { LegalNoticeFormHelperService } from '@pages/content-management/domain/services/legal-notice/legal-notice-form-helper.service';
import { FormValidators } from '@pages/content-management/domain/validators/form-validators';
import { LegalNoticeFormStore } from '@presentation/pages/content-management/application/store/legal-notice/legal-notice-form.store';
...
@Component({
    ...
    providers: [
        LegalNoticeFormHelperService,
        MessageService,
        LegalNoticeFormStore,
    ],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class LegalNoticeFormComponent {
    readonly store = inject(LegalNoticeFormStore);

    private readonly activatedRoute = inject(ActivatedRoute);
    private readonly destroyRef = inject(DestroyRef);
    private readonly translate = inject(TranslateService);
    private readonly submitFacade = inject(LegalNoticeFacade);
    private readonly helper = inject(LegalNoticeFormHelperService);
    ...
    navigateToBack(): void {
        this.helper.navigateToLegalNoticeList();
    }
}
