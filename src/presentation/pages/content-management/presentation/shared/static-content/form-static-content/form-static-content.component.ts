            ...
            <div class="card-body p-4">
                <form [formGroup]="form" (ngSubmit)="onSubmit()">
                    <fieldset class="fieldset">
                        <legend><b>{{ 'CONTENT_MANAGEMENT.STATIC_CONTENT.FORM.INFO' | translate }}</b></legend>
                        
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="version" class="form-label fw-bold">
                                    {{ 'CONTENT_MANAGEMENT.STATIC_CONTENT.FORM.VERSION' | translate }} 
                                ...
                                <input 
                                    ...
                                    class="w-100"
                                    [placeholder]="'CONTENT_MANAGEMENT.STATIC_CONTENT.FORM.VERSION_PLACEHOLDER' | translate" 
                                />
                            ...
                            @if (isEditMode && currentVersion) {
                                <div class="col-md-6 d-flex align-items-end">
                                    <div>
                                        <small class="text-muted d-block mb-1">{{ 'CONTENT_MANAGEMENT.STATIC_CONTENT.FORM.CURRENT_VERSION' | translate }}</small>
                                        <p-tag severity="info" [value]="currentVersion"></p-tag>
                                    </div>
                                </div>
                            }
                            ...
                            <div class="col-12">
                                <label for="content" class="form-label fw-bold">
                                    {{ 'CONTENT_MANAGEMENT.STATIC_CONTENT.FORM.CONTENT' | translate }} 
                                    <span class="text-danger">*</span>
                                </label>
