...
} from '@presentation/pages/administrative-infrastructure/presentation/infrastructure/infrastructure-paths.constants';

export const INFRASTRUCTURE_ROUTES: Routes = [
    {
        path: '',
        loadComponent: () =>
            import('@presentation/pages/administrative-infrastructure/presentation/infrastructure/infrastructure-page/infrastructure-page.component').then(
        ...
        children: [
            ...
            },
            {
                ...
                loadComponent: () =>
                    import('@presentation/pages/administrative-infrastructure/presentation/infrastructure/infrastructure-list/infrastructure-list.component').then(
    ...
    },
    {
        ...
        loadComponent: () =>
            import('@presentation/pages/administrative-infrastructure/presentation/infrastructure/infrastructure-form/infrastructure-form.component').then(
