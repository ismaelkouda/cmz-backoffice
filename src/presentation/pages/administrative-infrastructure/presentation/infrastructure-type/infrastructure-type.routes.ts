...
export const INFRASTRUCTURE_TYPE_ROUTES: Routes = [
    {
        path: '',
        loadComponent: () =>
            import('@presentation/pages/administrative-infrastructure/presentation/infrastructure-type/infrastructure-type-page/infrastructure-type-page.component').then(
        ...
        children: [
            ...
            },
            {
                ...
                loadComponent: () =>
                    import('@presentation/pages/administrative-infrastructure/presentation/infrastructure-type/infrastructure-type-list/infrastructure-type-list.component').then(
    ...
    },
    {
        ...
        loadComponent: () =>
            import('@presentation/pages/administrative-infrastructure/presentation/infrastructure-type/infrastructure-type-form/infrastructure-type-form.component').then(
