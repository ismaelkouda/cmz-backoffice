...
export class FilterTreatmentComponent implements OnInit, OnDestroy {
    ...
    readonly reportTypeOptions = [
        {
            ...
            label: 'REPORT_PROCESSING.TREATMENT.OPTIONS.REPORT_TYPE.PARTIAL_SIGNAL',
        },
        {
            value: 'zone blanche',
            label: 'REPORT_PROCESSING.TREATMENT.OPTIONS.REPORT_TYPE.WHITE_ZONE',
        },
        {
            value: "Absence d'internet",
            label: 'REPORT_PROCESSING.TREATMENT.OPTIONS.REPORT_TYPE.NO_INTERNET',
        },
    ] as const;
    ...
    readonly operatorOptions = [
        {
            value: 'orange',
            label: 'REPORT_PROCESSING.TREATMENT.OPTIONS.OPERATOR.ORANGE',
        },
        {
            value: 'mtn',
            label: 'REPORT_PROCESSING.TREATMENT.OPTIONS.OPERATOR.MTN',
        },
        {
            value: 'moov',
            label: 'REPORT_PROCESSING.TREATMENT.OPTIONS.OPERATOR.MOOV',
        },
    ] as const;
    ...
    readonly stateOptions = [
        {
            value: 'terminated',
            label: 'REPORT_PROCESSING.TREATMENT.OPTIONS.STATE.TERMINATED',
        },
        {
            value: 'in-progress',
            label: 'REPORT_PROCESSING.TREATMENT.OPTIONS.STATE.IN_PROGRESS',
        },
        {
            value: 'rejected',
            label: 'REPORT_PROCESSING.TREATMENT.OPTIONS.STATE.REJECTED',
        },
    ] as const;
