...
export class FilterFinalizeComponent implements OnInit, OnDestroy {
    ...
    readonly reportTypeOptions = [
        {
            value: 'zone blanche',
            label: 'REPORT_PROCESSING.FINALIZE.OPTIONS.REPORT_TYPE.WHITE_ZONE',
        },
    ] as const;
    ...
    readonly operatorOptions = [
        {
            value: 'orange',
            label: 'REPORT_PROCESSING.FINALIZE.OPTIONS.OPERATOR.ORANGE',
        },
        {
            value: 'mtn',
            label: 'REPORT_PROCESSING.FINALIZE.OPTIONS.OPERATOR.MTN',
        },
        {
            value: 'moov',
            label: 'REPORT_PROCESSING.FINALIZE.OPTIONS.OPERATOR.MOOV',
        },
    ] as const;
    ...
    readonly stateOptions = [
        {
            value: 'finalized',
            label: 'REPORT_PROCESSING.FINALIZE.OPTIONS.STATE.FINALIZED',
        },
        {
            value: 'pending',
            label: 'REPORT_PROCESSING.FINALIZE.OPTIONS.STATE.PENDING',
        },
        {
            value: 'rejected',
            label: 'REPORT_PROCESSING.FINALIZE.OPTIONS.STATE.REJECTED',
        },
    ] as const;
