...
> {
    ...
    protected override mapItemFromDto(dto: DetailsItemDto): DetailsEntity {
        ...
        console.log('dto.finalization_state', dto.finalization_state);

        const entity = new DetailsEntity(
            dto.uniq_id,
            dto.request_report_uniq_id,
            dto.initiator_phone_number,
            this.utils.memoized(dto.initiator, (i) =>
                this.actorMapper.mapToEntity(i)
            ),
            this.utils.memoized(dto.acknowledged_by, (a) =>
                this.actorMapper.mapToEntity(a)
            ),
            this.utils.memoized(dto.processed_by, (p) =>
                this.actorMapper.mapToEntity(p)
            ),
            this.utils.memoized(dto.approved_by, (a) =>
                this.actorMapper.mapToEntity(a)
            ),
            this.utils.memoized(dto.rejected_by, (r) =>
                this.actorMapper.mapToEntity(r)
            ),
            this.utils.memoized(dto.confirmed_by, (c) =>
                this.actorMapper.mapToEntity(c)
            ),
            this.utils.memoized(dto.abandoned_by, (a) =>
                this.actorMapper.mapToEntity(a)
            ),
            ...
            this.utils.memoized(dto.region, (r) =>
                this.administrativeBoundaryMapper.mapToEntity(r)
            ),
            this.utils.memoized(dto.department, (d) =>
                this.administrativeBoundaryMapper.mapToEntity(d)
            ),
            this.utils.memoized(dto.municipality, (m) =>
