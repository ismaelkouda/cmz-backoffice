...
import {
    ...
    NewspapersEntity,
    ReportStatus,
} from '../../domain/entities/management/newspapers/newspapers.entity';
...
> {
    ...
    private mapLocation(dto: NewspapersItemDto): ReportLocation {
    ...
    private mapMedia(dto: NewspapersItemDto): ReportMedia {
        return {
    ...
    private mapApprovalInfo(dto: NewspapersItemDto): ApprovalInfo {
        return {
    ...
    private mapDuplicationInfo(dto: NewspapersItemDto): DuplicationInfo {
        return {
    ...
    private mapTimestamps(dto: NewspapersItemDto): Newspapers['timestamps'] {
        return {
