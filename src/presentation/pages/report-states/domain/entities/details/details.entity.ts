...
import { detailsLabelButtonSubmit } from '@pages/report-states/domain/functions/details/details-label-button-submit.function';
...
import { detailsTitle } from '@pages/report-states/domain/functions/details/details-title.function';
...
export class DetailsEntity {
    ...
    //     return detailsPermissionsManage({
    //         props: this.props,
    //         permissions: {
    //             canTake: this.takePermission(),
    //             canQualify: this.qualifyPermission(),
    //         },
    //     });
    // }
