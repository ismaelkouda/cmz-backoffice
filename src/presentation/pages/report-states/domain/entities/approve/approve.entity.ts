...
export class ApproveEntity implements ApproveProps {
    constructor(private readonly props: ApproveProps) {}
    ...
    public with(props: ApproveProps): ApproveEntity {
        if (
        ...
        return new ApproveEntity(props);
    }
}
