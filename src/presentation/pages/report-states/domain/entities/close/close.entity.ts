...
export class CloseEntity implements CloseProps {
    constructor(private readonly props: CloseProps) {}
    ...
    public with(props: CloseProps): CloseEntity {
        if (
