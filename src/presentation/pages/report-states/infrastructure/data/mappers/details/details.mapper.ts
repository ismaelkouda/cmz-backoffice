...
import { DetailsItemApiDto } from '@pages/report-states/infrastructure/api/dto/details/details-response-api.dto';
import { StatusMapper } from '@pages/report-states/infrastructure/data/mappers/details/details-status.mapper';
