...
type PageAction =
    | { data: Object; action: 'détails'; view: 'modal' }
    | { data: Object; action: 'prendre-en-charge'; view: 'modal' };
...
export class TableFileAttenteComponent {
    ...
    public getStyleButtonTraitement(sim: any): Object | void {
        return {
            ...
            tooltip: 'identifier',
            typeTreatment: { module: 'file-attente', visualiser: true },
        };
    }
    ...
    OnShowModalTraitement(
        data: any,
        typeTreatment: { module: 'personne-physique'; visualiser: boolean }
    ): void {
