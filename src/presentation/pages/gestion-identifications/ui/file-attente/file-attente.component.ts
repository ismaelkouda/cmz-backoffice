...
export class FileAttenteComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.sharedDataService
            .postGestionIdentificationsFileAttente()
            .subscribe(() => {
        ...
        this.currentPage =
            this.stateFileAttenteService.getCurrentPageFileAttenteState();
    ...
    async pageCallback(dataToSend = {}, nbrPage: string = '1'): Promise<any> {
        const response: any = await handle(
            () =>
                this.gestionIdentificationsService.PostGestionIdentificationsFileAttentes(
                    dataToSend,
                    nbrPage
                ),
            this.toastrService,
    ...
    public onExportExcel(): void {
        ...
        this.excelService.exportAsExcelFile(
            data,
            'liste_dossiers_a_prendre_charge'
        );
    }
