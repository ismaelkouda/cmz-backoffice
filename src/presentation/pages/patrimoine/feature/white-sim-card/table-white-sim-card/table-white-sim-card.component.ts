import { DossierWhiteSimCard, TABLE_WHITE_SIM_CARD } from './../../../data-access/white-sim-card/table-white-sim-card';
...
export class TableWhiteSimCardComponent {
  ...
  public onExportExcel(): void {
    this.tableExportExcelFileService.exportAsExcelFile(this.listWhiteSimCard, this.table, "liste_dossiers_carte_sim_blanche");
  }
