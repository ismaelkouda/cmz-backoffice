...
export class TableWhiteSimCardDetailsComponent {
    ...
    public copyData(
        selectedDetailsWhiteSimCard: WhiteSimCardDetails,
        type: TYPECOPY
    ): void {
    ...
    public onExportExcel(): void {
        this.tableExportExcelFileService.exportAsExcelFile(
            this.listWhiteSimCardDetails.carte_sims,
            this.table,
            `liste_carte_sim_blanche_du_dossier_${this.listWhiteSimCardDetails.numero_demande}`
        );
    }
}
