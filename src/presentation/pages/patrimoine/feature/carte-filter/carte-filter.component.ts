    ...
    public initFormFilter() {
        this.formFilter = this.fb.group<any>({
            initie_par: new FormControl<string>(
                this.filterData?.['initie_par'] ?? null,
                { nonNullable: true }
            ),
            numero_demande: new FormControl<string>(
                this.filterData?.['numero_demande'] ?? null,
                { nonNullable: true }
            ),
            transaction: new FormControl<string>(
                this.filterData?.['transaction'] ?? null,
                { nonNullable: true }
            ),
            statut: new FormControl<string>(
                this.filterData?.['statut'] ?? null,
                { nonNullable: true }
            ),
            traitement: new FormControl<string>(
                this.filterData?.['traitement'] ?? null,
                { nonNullable: true }
            ),
            msisdn: new FormControl<string>(
                this.filterData?.['msisdn'] ?? null,
                {
                    nonNullable: true,
                    validators: [
                        Validators.required,
            ...
            date_debut: new FormControl<string>(
                this.filterData?.['date_debut'] ?? null,
                { nonNullable: true }
            ),
            date_fin: new FormControl<string>(
                this.filterData?.['date_fin'] ?? null,
                { nonNullable: true }
            ),
        });
