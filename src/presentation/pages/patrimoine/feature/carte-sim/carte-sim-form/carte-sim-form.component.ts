...
export class CarteSimFormComponent implements OnInit {
    ...
    constructor(
        ...
        private carteSimStateService: CarteSimStateService,
    ...
    private getParamsInUrl(): void {
        this.activatedRoute.queryParams.subscribe((params: Object) => {
            ...
            this.urlParamFilter =
                this.carteSimStateService.getFilterCarteSimState(
                    params?.['filter']
                );
        });
    ...
    private getCarteSimSelected(listCartesSim): void {
        this.carteSimSelected = listCartesSim.find(
            (e) => e.msisdn == this.urlParamId
        );
        ...
        if (this.carteSimSelected) {
            this.carteSimStateService.setItemSelectedState(
                this.carteSimSelected
            );
    ...
    private patchValueFormUpdateCarteSim(carteSimSelectedDetails: any): void {
        this.formUpdateCarteSim.patchValue({
            ...
            date_localisation: carteSimSelectedDetails?.date_localisation,
    ...
    async handleUpdateCampagne(): Promise<void> {
        ...
        const result = await Swal.mixin({
            ...
            html: htmlMessage.replace(
                '{msisdn}',
                this.carteSimSelectedDetails?.['msisdn']
            ),
        });
    ...
    public initFormUpdateCarteSim(): void {
        ...
        this.formUpdateCarteSim
            ?.get('niveau_un_uuid')
            ?.valueChanges.subscribe(this.getAllExploitation.bind(this));
    }
    ...
    async getAllExploitation(selectedDRId: number) {
        const response: any = await handle(
            () =>
                this.patrimoinesService.PostParametresSecuriteNiveauDeuxSimple({
                    niveau_un_uuid: selectedDRId,
                }),
            this.toastrService,
            this.loadingBar
        );
    ...
    async getAllDR(): Promise<void> {
        const response: any = await handle(
            () =>
                this.patrimoinesService.PostParametresSecuriteNiveauUnSimple(
                    {}
                ),
            this.toastrService,
            this.loadingBar
    ...
    async getAllUsages(): Promise<void> {
        const response: any = await handle(
            () => this.patrimoinesService.PostPatrimoineSimSimsAllUsages({}),
            this.toastrService,
            this.loadingBar
        );
    ...
    async getAllZones(): Promise<void> {
        const response: any = await handle(
            () =>
                this.patrimoinesService.PostParametresSecuriteNiveauTroisSimple(
                    {}
                ),
            this.toastrService,
            this.loadingBar
