...
export class PatrimoineService {
    ...
    GetAllPatrimoines(data, page): Observable<any> {
        const url: string = (<string>EndPointUrl.GET_ALL_PATRIMOINES).replace(
            '{page}',
            page
        );
    ...
    OnGetDetailSim(data): Observable<any> {
        const url: string = (<string>EndPointUrl.DETAILS_SIM).replace(
            '{imsi}',
            data
        );
    ...
    GetAllCycles(data, page): Observable<any> {
        const url: string = (<string>EndPointUrl.GET_ALL_CYCLES).replace(
            '{page}',
            page
        );
        return this.http.post(`${this.baseUrl}${url}`, data);
    ...
    GetAllEtats(data, page): Observable<any> {
        const url: string = (<string>EndPointUrl.GET_ALL_ETAT_SOLDE).replace(
            '{page}',
            page
        );
        return this.http.post(`${this.baseUrl}${url}`, data);
    ...
    PostPatrimoineSimCartonSimBlancheDisponibles(
        data: Object
    ): Observable<any> {
    ...
    IdentificationPatrimoineUpdate(data): Observable<any> {
        const url: string = <string>(
            EndPointUrl.IDENTIFICATION_PATRIMOINE_UPDATE
        );
        return this.http.post(`${this.baseUrl}${url}`, data);
    }
    ...
    HandleDeleteGroupe(data): Observable<any> {
        const url: string = (<string>EndPointUrl.DELETE_GROUPE).replace(
            '{id}',
            data
        );
    ...
    GetAllSimNoGroupe(data, page): Observable<any> {
        const url: string = (<string>EndPointUrl.GET_ALL_SIM_NO_GROUPE).replace(
            '{page}',
            page
        );
        return this.http.post(`${this.baseUrl}${url}`, data);
    ...
    GetAllsimAtGroupe(data, page): Observable<any> {
        const url: string = (<string>EndPointUrl.GET_ALL_SIM_AT_GROUPE).replace(
            '{page}',
            page
        );
        return this.http.post(`${this.baseUrl}${url}`, data);
    ...
    handleActivateGroupe(data): Observable<any> {
        const url: string = (<string>EndPointUrl.ACTIVATE_GROUPE).replace(
            '{id}',
            data
        );
    ...
    handleDisableGroupe(data): Observable<any> {
        const url: string = (<string>EndPointUrl.DISABLE_GROUPE).replace(
            '{id}',
            data
        );
        return this.http.put(`${this.baseUrl}${url}`, {});
    ...
    GetAllDotations(data, page): Observable<any> {
        const url: string = (<string>EndPointUrl.GET_ALL_DOTATION).replace(
            '{page}',
            page
        );
        return this.http.post(`${this.baseUrl}${url}`, data);
    ...
    GetAllDownlaod(page): Observable<any> {
        const url: string = (<string>EndPointUrl.DOWNLOAD_FILE).replace(
            '{page}',
            page
        );
