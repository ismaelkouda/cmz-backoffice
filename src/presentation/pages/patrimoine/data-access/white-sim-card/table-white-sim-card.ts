export const TABLE_WHITE_SIM_CARD = {
    cols: [
        ...
        { field: 'reference', header: 'Référence du lot', class: "text-center", width: "12rem" },
        ...
        { field: 'nb_numeros_disponibles', header: '# Cartes Restantes', class: "text-center", width: "10rem" },
    ...
    globalFilterFields: ['created_at','reference','nb_numeros_total','nb_numeros_utilises','nb_numeros_disponibles','statut','taux_utilisation']
}
