...
export class DotationServiceComponent implements OnInit {
    ...
    public title =
        'Dotations service - Système de Gestion de Collecte Centralisée';
    constructor(
    ...
    public GetAllDotations() {
        this.patrimoineService.GetAllDotations({}, this.p).subscribe({
            next: (response) => {
    ...
    public disableAction(): boolean {
        return this.listDotations === undefined ||
            this.listDotations?.length === 0
            ? true
            : false;
    }
    public isFilter(): boolean {
        return !this.selectedNumero &&
            !this.selectedSim &&
            !this.selectedimsi &&
