...
export class GroupeSimComponent implements OnInit {
    ...
    public GetAllGroupes(): void {
        this.patrimoineService.GetAllGroupes({}).subscribe({
            next: (response) => {
    ...
    public handleActivateProfil(data: any): void {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                this.patrimoineService.handleActivateGroupe(data.id).subscribe({
                    next: (response) => {
    ...
    public handleDisableProfil(data: any): void {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                this.patrimoineService.handleDisableGroupe(data.id).subscribe({
                    next: (response) => {
                        this.toastrService.success(response.message);
                        this.GetAllGroupes();
                    },
    ...
    public HandleDeleteGroupe(data: any): void {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                this.patrimoineService.HandleDeleteGroupe(data.id).subscribe({
                    next: (response) => {
                        this.toastrService.success(response.message);
                        this.GetAllGroupes();
                    },
    ...
    public isFilter(): boolean {
        return !this.selectedNom && !this.selectedImsi && !this.selectedMsisdn
            ? true
            : false;
    }
