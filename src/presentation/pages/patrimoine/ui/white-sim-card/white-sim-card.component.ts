...
export class WhiteSimCardComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.pageCallbackSubscription = this.sharedDataService
            .postPatrimoineWhiteSimCard()
            .subscribe(() => {
                this.pageCallback();
            });
        ...
        this.currentPage =
            this.stateWhiteSimCardService.getCurrentPageWhiteSimCardState();
        this.selectedWhiteSimCard =
            this.stateWhiteSimCardService.getItemSelectedState();
