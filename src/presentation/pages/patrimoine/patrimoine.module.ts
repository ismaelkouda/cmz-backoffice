...
// import { SmsBalanceStatusComponent } from '../patrimony/ui/sms-balance-status/sms-balance-status.component';
...
// import { DetailsSmsBalanceStatusComponent } from './feature/sms-balance-status/details-sms-balance-status/details-sms-balance-status.component';
// import { TableDetailsSmsBalanceStatusComponent } from './feature/sms-balance-status/details-sms-balance-status/features/table-details-sms-balance-status/table-details-sms-balance-status.component';
// import { FilterDetailsSmsBalanceStatusComponent } from './feature/sms-balance-status/details-sms-balance-status/features/filter-details-sms-balance-status/filter-details-sms-balance-status.component';
// import { StateSmsBalanceStatusService } from './data-access/sms-balance-status/state-sms-balance-status.service';
// //Module
...
//         SmsBalanceStatusComponent, FilterSmsBalanceStatusComponent, TableSmsBalanceStatusComponent, DetailsSmsBalanceStatusComponent, TableDetailsSmsBalanceStatusComponent, FilterDetailsSmsBalanceStatusComponent,
...
//         StateWhiteSimCardService, StateSmsBalanceStatusService
//     ]
// })
