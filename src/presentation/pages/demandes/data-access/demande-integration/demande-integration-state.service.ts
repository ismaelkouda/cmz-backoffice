...
export class DemandeIntegrationStateService {
    ...
    setParginateState(state: any): void {
        ...
        this.encodingDataService.saveData('parginateState', JSON.stringify(state));
    }
     ...
     */
    generateQueryStringFromObject = (dataFilter: Record<string, any> = {}): string => {
 ...
 */
    parseQueryStringToObject = (queryString: string): Record<string, string | null> => {
