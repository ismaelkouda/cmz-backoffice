...
export class TypePaiementComponent implements OnInit {
    ...
    public initFormTypePaiement(): void {
        this.formTypePaiement = this.fb.group({
            ...
            niveau_trois_uuid: this.createFormControl(this.detailsDemande?.["niveau_trois_nom"], null, true),
            usage_id: this.createFormControl(this.detailsDemande?.["usage_nom"], null, true),
            qte: this.createFormControl(this.detailsDemande?.["facture"]?.["qte"], null, true),
            prix_ht: this.createFormControl(this.detailsDemande?.["facture"]?.["prix_ht"], null, true),
            prix_ttc: this.createFormControl(this.detailsDemande?.["facture"]?.["prix_ttc"], null, true),
            formule_uuid: this.createFormControl(this.truncateString(this.detailsDemande?.["formule"]), Validators.required, true),
            description: this.createFormControl(this.detailsDemande?.["description"], null, true),
            prix_unitaire: this.createFormControl(this.detailsDemande?.["facture"]?.["prix_unitaire"], null, true),
            montant: this.createFormControl(this.detailsDemande?.["montant"], null, true),

            type_paiement: this.createFormControl(this.getNonNullValue(this.detailsDemande?.["type_paiement"]), Validators.required, false),
            recu_paiement: this.createFormControl(this.detailsDemande?.["recu_paiement"], null, false),
