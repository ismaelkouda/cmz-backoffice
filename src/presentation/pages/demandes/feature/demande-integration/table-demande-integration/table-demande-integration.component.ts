...
export class TableDemandeIntegrationComponent {
    @Output() interfaceUser = new EventEmitter<{
        data: any;
        paramUrl: TYPEFORM;
    }>();
    ...
    public onAction(
        ...
        switch (type) {
            case 'page':
                ...
                this.demandeIntegrationStateService.setTableState(
    ...
    public getStyleButtonTraitement(data: any): Object {
        if (
            ...
            !(
                data?.statut === BADGE_ETAPE.CLOTURE &&
                data.traitement === BADGE_ETAT.ABANDONNE
            )
        ) {
            return {
    ...
    private selectDemandeIntegration(selectedDemandeIntegration: Object): void {
        ...
        this.demandeIntegrationStateService.setTableItemSelectedState(
            selectedDemandeIntegration
        );
    }
