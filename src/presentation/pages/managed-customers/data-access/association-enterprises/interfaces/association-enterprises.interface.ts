...
export interface AssociationEnterprisesInterface {
    id: number;
...
export interface AssociationEnterprisesStatsInterface {
    ...
    data: Paginate<AssociationEnterprisesInterface>;
}

export interface AssociationEnterprisesApiResponseInterface {
    error: boolean;
    message: string;
    data: Paginate<AssociationEnterprisesStatsInterface>;
}
