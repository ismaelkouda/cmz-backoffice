...
export interface CommercialEnterprisesInterface {
    id: number;
...
export interface CommercialEnterprisesStatsInterface {
    ...
    data: Paginate<CommercialEnterprisesInterface>;
}

export interface CommercialEnterprisesApiResponseInterface {
    error: boolean;
    message: string;
    data: Paginate<CommercialEnterprisesStatsInterface>;
}
