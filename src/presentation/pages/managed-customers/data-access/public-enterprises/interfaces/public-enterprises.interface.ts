...
export interface PublicEnterprisesInterface {
    id: number;
...
export interface PublicEnterprisesStatsInterface {
    ...
    data: Paginate<PublicEnterprisesInterface>;
}

export interface PublicEnterprisesApiResponseInterface {
    error: boolean;
    message: string;
    data: Paginate<PublicEnterprisesStatsInterface>;
}
