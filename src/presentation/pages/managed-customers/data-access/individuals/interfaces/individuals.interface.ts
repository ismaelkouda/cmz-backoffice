...
export interface IndividualsInterface {
    id: number;
...
export interface IndividualsStatsInterface {
    ...
    data: Paginate<IndividualsInterface>;
}

export interface IndividualsApiResponseInterface {
    error: boolean;
    message: string;
    data: Paginate<IndividualsStatsInterface>;
}
