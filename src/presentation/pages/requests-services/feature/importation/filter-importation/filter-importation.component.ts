...
@Component({
    selector: 'app-filter-importation',
    templateUrl: './filter-importation.component.html',
    styleUrls: ['./filter-importation.component.scss'],
})
export class FilterImportationComponent implements OnInit {
    ...
    @Input() filterData: ImportationFilterInterface;

    @Output() filter = new EventEmitter<ImportationFilterInterface>();
    ...
    public initFormFilter(): void {
        this.formFilter = this.fb.group<ImportationFilterInterface>({
