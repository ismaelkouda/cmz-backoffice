...
export class FilterDataBalanceStatusComponent implements OnDestroy {
    ...
    constructor(private toastService: ToastrService, private fb: FormBuilder,
        ...
        private secondLevelService: SecondLevelService, private dataBalanceStatusApiService: dataBalanceStatusApiService) {
        this.initFormFilter();
    ...
    public initFormFilter(): void {
        this.dataBalanceStatusApiService.getDataFilterDataBalanceStatus().pipe(takeUntil(this.destroy$)).subscribe((filterData: dataBalanceStatusFilterInterface) => {
    ...
    private expandedSecondLine(filterData: dataBalanceStatusFilterInterface): void {
