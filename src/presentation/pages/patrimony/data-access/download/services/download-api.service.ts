...
import { downloadApiResponseInterface, downloadInterface } from '../interfaces/download.interface';
...
export class downloadApiService {
    ...
    private downloadPagination = new BehaviorSubject<Paginate<downloadInterface>>({} as Paginate<downloadInterface>);
    private downloadSelected = new BehaviorSubject<downloadInterface>({} as downloadInterface);
    ...
    private apiResponseDownloadSubject = new BehaviorSubject<downloadApiResponseInterface>({} as downloadApiResponseInterface);
    ...
    fetchDownload(nbrPage: string = '1'): void {
        ...
        const url: string = downloadEndpointEnum.GET_PATRIMOINE_SIM_DOWNLOAD_FILE_ALL_PAGE.replace('{page}', nbrPage);
