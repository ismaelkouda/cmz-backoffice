export const smsBalanceStatusTableConstant = {
    cols: [
        ...
        { field: 'point_emplacement', header: 'Nom Emplacement', width: "10rem" },
        { field: 'msisdn', header: 'MSISDN', class: "text-center", width: "6rem" },
        { field: 'imsi', header: 'IMSI', class: "text-center", width: "6rem" },
        { field: 'solde_actuel_go', header: 'Solde SMS', class: "text-center", width: "6rem" },
        { field: 'updated_at', header: 'Date Solde', class: "text-center", width: "6rem" }
    ],
    globalFilterFields: ['niveau_uns_nom', 'niveau_deux_nom', 'niveau_trois_nom', 'apn', 'point_emplacement', 'msisdn', 'imsi', 'solde_actuel_go', 'updated_at']
};
