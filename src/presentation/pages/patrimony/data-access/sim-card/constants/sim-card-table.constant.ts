...
export const simCardTableConstant = (asFeatureService: AsFeatureService) => {
    ...
    return {
        cols: [
            ...
            { field: 'niveau_uns_nom', header: 'Niveau un', class: "text-center" },
            { field: 'niveau_deux_nom', header: 'Niveau deux', class: "text-center" },
            { field: 'apn', header: 'APN', class: "text-center", width: "6rem" },
            { field: 'adresse_ip', header: 'Adresse IP', class: "text-center", width: "6rem" },
            ...
            { field: '', header: 'Actions', class: "text-center", width: "fix-content" }
        ],
        globalFilterFields: [
