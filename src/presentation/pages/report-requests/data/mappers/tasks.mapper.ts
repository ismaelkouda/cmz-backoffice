...
import { TasksItemDto } from '@presentation/pages/report-requests/data/dtos/tasks/tasks-response.dto';
import {
    ReportStatus,
    Tasks,
    TasksEntity,
} from '@presentation/pages/report-requests/domain/entities/tasks/tasks.entity';
