...
import { ApprovalItemDto } from '../dtos/approval/approval-response.dto';

@Injectable({
    providedIn: 'root',
})
export class ApprovalMapper extends PaginatedMapper<
    ApprovalEntity,
    ApprovalItemDto
> {
    protected override mapItemFromDto(dto: ApprovalItemDto): ApprovalEntity {
