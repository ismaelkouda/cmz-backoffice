...
export class AllEntity implements All {
    ...
    public toString(): string {
        return `AllEntity[id=${this.id}, type=${this.reportType}, status=${this.status}, operators=${this.operators.join(',')}]`;
    }
    ...
    public markAsApproved(approvedBy: string, comment: string = ''): AllEntity {
        return this.clone({
    ...
    public markAsRejected(rejectedBy: string, comment: string = ''): AllEntity {
        return this.clone({
