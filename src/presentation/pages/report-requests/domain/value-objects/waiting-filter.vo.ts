import { WaitingFilterPayloadEntity } from '../entities/waiting/waiting-filter-payload.entity';

export class WaitingFilter {
    private constructor(
    ...
    static create(data: WaitingFilterPayloadEntity): WaitingFilter {
        return new WaitingFilter(
            data.created_from,
            data.created_to,
            data.report_type,
            data.state,
