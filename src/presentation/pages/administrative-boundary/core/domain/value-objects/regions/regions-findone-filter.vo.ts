...
export class RegionsFindoneFilter {
    ...
    static create(
        data: RegionsFindoneFilterDto = {} as RegionsFindoneFilterDto
    ): RegionsFindoneFilter {
        return new RegionsFindoneFilter(data.code);
    }

    toDto(): RegionsFindoneFilterApiDto {
        const params: RegionsFindoneFilterApiDto =
            {} as RegionsFindoneFilterApiDto;
