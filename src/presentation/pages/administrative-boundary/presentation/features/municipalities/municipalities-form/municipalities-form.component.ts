...
export class MunicipalitiesFormComponent {
    ...
    readonly currentMunicipality = toSignal(this.findOneFacade.item$, {
        initialValue: null,
    });
    ...
    public getErrorMessage(fieldName: string): string {
        ...
        if (errors['pattern']) {
            return this.translate.instant(
                'ADMINISTRATIVE_BOUNDARY.MUNICIPALITIES.FORM.VALIDATION.INVALID_FORMAT'
            );
        }
        return this.translate.instant(
            'ADMINISTRATIVE_BOUNDARY.MUNICIPALITIES.FORM.VALIDATION.INVALID_INPUT'
        );
    }
