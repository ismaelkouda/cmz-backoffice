...
import { DEPARTMENTS_BY_REGION_ID_ROUTE, REGIONS_FORM } from "../regions.routes";
...
export class RegionsListComponent implements OnInit {
    ...
    readonly pagination = toSignal(this.facade.pagination$, { initialValue: {} as Paginate<RegionsEntity> });
    ...
    constructor() {
        this.title.setTitle(this.translate.instant("ADMINISTRATIVE_BOUNDARY.REGIONS.TITLE"));
        effect(() => {
        ...
        this.filterFields = [
            {
                ...
                placeholder: 'ADMINISTRATIVE_BOUNDARY.REGIONS.FILTER.SEARCH_PLACEHOLDER',
            },
            /* {
                type: 'select',
                name: 'isActive',
            ...
            }, */
            {
                ...
                placeholder: 'ADMINISTRATIVE_BOUNDARY.REGIONS.FILTER.DATE.PLACEHOLDER',
            },
            {
                type: 'date',
                name: 'endDate',
    ...
    public onEditClicked({ item, ref }: { item: RegionsEntity, ref: CrudFormType }): void {
        this.router.navigate([REGIONS_FORM], {
            relativeTo: this.activatedRoute,
            queryParams: {
                code: item.code,
    ...
    public onDeleteClicked(item: RegionsEntity): void {
        ...
        SweetAlert.fire({
            ...SWEET_ALERT_PARAMS,
            title: this.translate.instant('ADMINISTRATIVE_BOUNDARY.REGIONS.SWEET_ALERT.TITLE_DELETE'),
    ...
    public onBadgeClick(event: { item: RegionsEntity; col: HTMLTableCellElement }): void {
