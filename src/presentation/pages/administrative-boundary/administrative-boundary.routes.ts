                ...
                children: [
                    {
                        path: '',
                        loadChildren: () =>
                            import('./presentation/departments/departments.routes').then(
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () =>
                            import('./presentation/municipalities/municipalities.routes').then(
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () =>
                            import('./presentation/regions/regions.routes').then(
                                (m) => m.REGIONS_ROUTES
                            ),
                        data: { breadcrumb: { hide: true } },
                    },
