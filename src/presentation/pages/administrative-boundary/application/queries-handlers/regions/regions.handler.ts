import { regionsQueryMapper } from '@pages/administrative-boundary/application/queries-mappers/regions/regions.mapper';
...
export class RegionsHandler {
    ...
    execute(
        ...
        return this.useCase.execute(regionsQueryMapper(command), page, options);
    }
}
