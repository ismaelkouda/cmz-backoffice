...
export class ThirdLevelComponent implements OnInit, OnDestroy {
    ...
    public GellCurrentLevel() {
        this.settingService.getAllZones({}, this.p).subscribe({
            next: (response) => {
    ...
    public GellAllSecondLevel() {
        this.settingService.GetAllSecondLevelSimple({}).subscribe({
            next: (response) => {
    ...
    public handleActivate(data: any): void {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                this.settingService.handleActivateZone(data.id).subscribe({
                    next: (response) => {
    ...
    public handleDisable(data: any): void {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                this.settingService.handleDisableZone(data.id).subscribe({
                    next: (response) => {
                        this.toastrService.success(response.message);
                        this.GellCurrentLevel();
                    },
    ...
    public HandleDelete(data: any): void {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                this.settingService.HandleDeleteZone(data.id).subscribe({
                    next: (response) => {
                        this.toastrService.success(response.message);
                        this.GellCurrentLevel();
                    },
