...
> {
    ...
    protected mapItemFromDto(dto: DashboardItemApiDto): DashboardEntity {
        ...
        const props: DashboardProps = {
            ...
            totalReportsPending: dto.total_request_report_pending,
            totalReportsInProcessing: dto.total_request_report_rejected,
            totalReportsProcessed: dto.total_reports_in_processing,
