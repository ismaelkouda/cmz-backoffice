...
export class DashboardApiService {
  ...
  private loadingDashboardStatisticSubject = new BehaviorSubject<boolean>(false);
  ...
  fetchDashboardStatistic(): void {
    ...
    this.http.get<Object>(`${this.BASE_URL}${url}`)
      .pipe(
        debounceTime(1000),
        ...
        finalize(() => this.loadingDashboardStatisticSubject.next(false))
      )
      .subscribe();
  }
