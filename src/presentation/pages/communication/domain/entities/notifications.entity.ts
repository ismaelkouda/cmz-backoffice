...
export class NotificationsEntity implements Notifications {
    ...
    public get reportDescription(): string {
        const reportDescription: Record<string, string> = {
            ABI: 'COMMUNICATION.NOTIFICATIONS.OPTIONS.REPORT_TYPE.NO_INTERNET',
            CPS: 'COMMUNICATION.NOTIFICATIONS.OPTIONS.REPORT_TYPE.PARTIAL_SIGNAL',
            CPO: 'COMMUNICATION.NOTIFICATIONS.OPTIONS.REPORT_TYPE.PARTIAL_OPERATOR',
            ZOB: 'COMMUNICATION.NOTIFICATIONS.OPTIONS.REPORT_TYPE.WHITE_ZONE',
        };
    ...
    public get sourceDescription(): string {
        const sourceDescription: Record<string, string> = {
            App: 'COMMUNICATION.NOTIFICATIONS.OPTIONS.SOURCE.APP',
            USSD: 'COMMUNICATION.NOTIFICATIONS.OPTIONS.SOURCE.USSD',
            SMS: 'COMMUNICATION.NOTIFICATIONS.OPTIONS.SOURCE.SMS',
            IVR: 'COMMUNICATION.NOTIFICATIONS.OPTIONS.SOURCE.IVR',
        };
