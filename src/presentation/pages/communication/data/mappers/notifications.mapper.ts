...
export class NotificationsMapper extends PaginatedMapper<NotificationsEntity, NotificationsItemDto> {
    ...
    private mapLocation(dto: NotificationsItemDto): ReportLocation {
    ...
    private mapMedia(dto: NotificationsItemDto): ReportMedia {
        return {
    ...
    private mapApprovalInfo(dto: NotificationsItemDto): ApprovalInfo {
        return {
    ...
    private mapDuplicationInfo(dto: NotificationsItemDto): DuplicationInfo {
        return {
