...
import { Folder } from '../../../../../shared/interfaces/folder';
    ...
    export class WaitingQueueComponent implements OnInit {
        ...
        ngOnInit(): void {
            ...
            this.pagination$ = this.waitingQueueApiService.getWaitingQueuePagination();
            this.waitingQueueSelected$ = this.waitingQueueApiService.getWaitingQueueSelected();
            ...
            combineLatest([
                ...
                this.waitingQueueApiService.fetchWaitingQueue(filterData, nbrPageData);
            });
        }
        ...
        public onPageChange(event: number): void {
            this.waitingQueueApiService.fetchWaitingQueue(this.filterData, JSON.stringify(event + 1))
        }
    }
