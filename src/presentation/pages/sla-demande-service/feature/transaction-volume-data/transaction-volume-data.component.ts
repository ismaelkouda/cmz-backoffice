...
@Component({
  selector: 'app-transaction-volume-data',
  templateUrl: './transaction-volume-data.component.html',
  styleUrls: ['./transaction-volume-data.component.scss']
})
export class TransactionVolumeDataComponent implements OnInit {
  ...
  public onFilter(): void {
    ...
    this.slaDemandeService
      .GetAllVolumeTransactions(data, this.p)
      .subscribe({
        next: (response) => {
