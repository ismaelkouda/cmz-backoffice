...
@Component({
  selector: 'app-transaction-resiliation',
  templateUrl: './transaction-resiliation.component.html',
  styleUrls: ['./transaction-resiliation.component.scss']
})
export class TransactionResiliationComponent implements OnInit {
  ...
  public onFilter(): void {
    ...
    this.slaDemandeService
      .GetAllResiliationTransactions(data, this.p)
      .subscribe({
        next: (response) => {
