...
@Component({
  selector: 'app-transaction-suspension',
  templateUrl: './transaction-suspension.component.html',
  styleUrls: ['./transaction-suspension.component.scss']
})
export class TransactionSuspensionComponent implements OnInit {
  ...
  public onFilter(): void {
    ...
    this.slaDemandeService
      .GetAllSuspensionTransactions(data, this.p)
      .subscribe({
        next: (response) => {
