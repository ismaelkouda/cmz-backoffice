import { SmsBalance, TABLE_SMS_BALANCE } from './../../../data-access/sms-balance/table-sms-balance';
...
export class TableSmsBalanceComponent {
  ...
  constructor(public toastService: ToastrService, private sharedDataService: SharedDataService,
    ...
    public copyData(selectedDetailsSmsBalance: SmsBalance, type: TYPECOPY): void {
  ...
  public onExportExcel(): void {
    this.tableExportExcelFileService.exportAsExcelFile(this.listSmsBalance, this.table, "liste_solde_sms");
  }
  ...
  public showJournal(selectedSmsBalance: Object): void {
      ...
      modalRef.componentInstance.numero_demande = selectedSmsBalance['reference'];
  }
