...
import {
    DataBalance,
    TABLE_SMS_BALANCE,
} from './../../../data-access/data-balance/table-data-balance';
...
type PageAction =
    | { data: DataBalance; action: 'détails'; view: 'page' }
...
export class TableDataBalanceComponent {
    ...
    public copyData(
        selectedDetailsDataBalance: DataBalance,
        type: TYPECOPY
    ): void {
    ...
    public viewDataBalanceDetails(params: {
        data: DataBalance;
        action: 'visualiser';
        view: 'page';
    }): void {
