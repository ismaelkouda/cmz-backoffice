...
export class ProfilSupervisionComponent implements OnInit {
    ...
    public title =
        'Profils supervision - Système de Gestion de Collecte Centralisée';
    ...
    public GetAllAlertPrevention(): void {
        this.telemetrieService.GetAllPrevention({}).subscribe({
            next: (response) => {
    ...
    public handleActivateProfil(data: any): void {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                this.telemetrieService.handleActivateProfil(data.id).subscribe({
                    next: (response) => {
    ...
    public handleDisableProfil(data: any): void {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                this.telemetrieService.handleDisableProfil(data.id).subscribe({
                    next: (response) => {
                        this.toastrService.success(response.message);
                        this.GetAllProfilSupervision();
                    },
