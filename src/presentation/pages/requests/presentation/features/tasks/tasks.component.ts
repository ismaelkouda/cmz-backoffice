...
import { TASKS_TABLE } from '@presentation/pages/requests/presentation/adapters/tasks/tasks-table.constants';
...
export class TasksComponent {
    ...
    private readonly canQualify = this.permissionActions.can(
        '/requests/tasks',
        'approve'
    );
        ...
        return [
            {
                ...
                label: this.t('REQUESTS.TASKS.FILTER.INITIATOR'),
                placeholder: this.t('COMMON.PHONE_PLACEHOLDER'),
                icon: 'pi pi-phone',
                translationKeys: {
                    label: 'REQUESTS.TASKS.FILTER.INITIATOR',
            ...
            },
            {
                type: 'text',
                name: 'uniqId',
                label: this.t('REQUESTS.TASKS.FILTER.UNIQ_ID'),
                placeholder: this.t('COMMON.REPORT_UNIQ_ID_PLACEHOLDER'),
                icon: 'pi pi-id-card',
                translationKeys: {
                    label: 'REQUESTS.TASKS.FILTER.UNIQ_ID',
            ...
            },
            {
                type: 'select',
                name: 'reportType',
                label: this.t('REQUESTS.TASKS.FILTER.REPORT_TYPE'),
            ...
            },
            {
                type: 'multi-select',
                name: 'operators',
                label: this.t('REQUESTS.TASKS.FILTER.OPERATORS'),
                placeholder: this.t('COMMON.SELECT_PLACEHOLDER'),
            ...
            },
            {
                type: 'select',
                name: 'source',
                label: this.t('REQUESTS.TASKS.FILTER.SOURCE'),
                placeholder: this.t('COMMON.SELECT_PLACEHOLDER'),
                ...
                icon: 'pi pi-filter',
                translationKeys: {
                    label: 'REQUESTS.TASKS.FILTER.SOURCE',
                },
            },
            {
                type: 'date',
    ...
    private readonly exportTooltip = computed(() => {
        ...
        if (permission) {
            return this.t('REQUESTS.TASKS.TOOLTIP.NO_PERMISSION_EXPORT');
        }
        if (noData) {
            return this.t('REQUESTS.TASKS.TOOLTIP.NO_EXPORT');
        }
        return this.t('REQUESTS.TASKS.TOOLTIP.EXPORT').replace(
            '{nb}',
