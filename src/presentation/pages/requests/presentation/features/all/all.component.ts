...
import { ALL_TABLE } from '@presentation/pages/requests/presentation/adapters/all/all-table.constants';
        ...
        return [
            {
                ...
                label: this.t('REQUESTS.ALL.FILTER.INITIATOR'),
                placeholder: this.t('COMMON.PHONE_PLACEHOLDER'),
                icon: 'pi pi-phone',
                translationKeys: {
                    label: 'REQUESTS.ALL.FILTER.INITIATOR',
            ...
            },
            {
                type: 'text',
                name: 'uniqId',
                label: this.t('REQUESTS.ALL.FILTER.UNIQ_ID'),
                placeholder: this.t('COMMON.REPORT_UNIQ_ID_PLACEHOLDER'),
                icon: 'pi pi-id-card',
                translationKeys: {
                    label: 'REQUESTS.ALL.FILTER.UNIQ_ID',
            ...
            },
            {
                type: 'select',
                name: 'reportType',
                label: this.t('REQUESTS.ALL.FILTER.REPORT_TYPE'),
            ...
            },
            {
                type: 'multi-select',
                name: 'operators',
                label: this.t('REQUESTS.ALL.FILTER.OPERATORS'),
                placeholder: this.t('COMMON.SELECT_PLACEHOLDER'),
            ...
            },
            {
                type: 'select',
                name: 'source',
                label: this.t('REQUESTS.ALL.FILTER.SOURCE'),
                placeholder: this.t('COMMON.SELECT_PLACEHOLDER'),
    ...
    private exportData(): void {
        ...
        this.excelExport
            .exportToExcel({
                ...
                data: items,
                sheetName: this.translate.instant('REQUESTS.ALL.TITLE'),
                autoFilter: true,
            })
            .catch((err) => {
