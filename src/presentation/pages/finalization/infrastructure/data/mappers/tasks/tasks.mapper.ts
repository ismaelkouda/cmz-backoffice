...
import { TasksProps } from '@pages/finalization/domain/interfaces/tasks/tasks-props.interface';
import { TasksItemApiDto } from '@pages/finalization/infrastructure/api/dto/tasks/tasks-response-api.dto';
