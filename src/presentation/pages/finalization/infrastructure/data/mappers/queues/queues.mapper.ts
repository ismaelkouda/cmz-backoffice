...
import { QueuesProps } from '@pages/finalization/domain/interfaces/queues/queues-props.interface';
import { QueuesItemApiDto } from '@pages/finalization/infrastructure/api/dto/queues/queues-response-api.dto';
