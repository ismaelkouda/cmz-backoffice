export const ProfileHabilitationEndpoint = {
    ...
    ENABLE: 'permission-profiles/enable',
    DISABLE: 'permission-profiles/disable',
    WITHOUT_USER: 'permission-profiles/withoutUser',
    REASSIGNED: 'permission-profiles/reassign',
