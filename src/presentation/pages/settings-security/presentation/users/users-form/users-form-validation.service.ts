...
export class UsersFormValidationService {
    ...
    getErrorMessage(
        ...
        if (errors['minlength']) {
            ...
            return `${this.translate.instant(
                'SETTINGS_SECURITY.USERS.FORM.VALIDATION.MIN_LENGTH'
        ...
        if (errors['maxlength']) {
            ...
            return `${this.translate.instant(
                'SETTINGS_SECURITY.USERS.FORM.VALIDATION.MAX_LENGTH'
            )}: ${error.requiredLength}`;
        }

        if (errors['pattern']) {
            return this.translate.instant(
                'SETTINGS_SECURITY.USERS.FORM.VALIDATION.INVALID_FORMAT'
            );
        }
        ...
        return this.translate.instant(
            'SETTINGS_SECURITY.USERS.FORM.VALIDATION.INVALID_INPUT'
        );
    }
