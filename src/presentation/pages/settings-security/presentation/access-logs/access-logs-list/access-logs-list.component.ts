...
export class AccessLogsListComponent implements OnInit {
    ...
    public readonly actionsOptions = signal<FilterOption[]>([]);
    ...
    private setPageTitle(): void {
        this.title.setTitle(
            this.translate.instant('SETTINGS_SECURITY.ACCESS_LOGS.TITLE')
        );
    }
        ...
        this.actionsOptions.set([
            {
                label: this.translate.instant(
                    'SETTINGS_SECURITY.ACCESS_LOGS.FILTER.ACTIONS_OPTIONS.LOGIN'
                ),
                value: 'login',
            },
            {
                label: this.translate.instant(
                    'SETTINGS_SECURITY.ACCESS_LOGS.FILTER.ACTIONS_OPTIONS.LOGOUT'
                ),
                value: 'logout',
            },
            {
                label: this.translate.instant(
                    'SETTINGS_SECURITY.ACCESS_LOGS.FILTER.ACTIONS_OPTIONS.ATTEMPTED_LOGIN'
                ),
                value: 'attempted_login',
            },
            {
                label: this.translate.instant(
                    'SETTINGS_SECURITY.ACCESS_LOGS.FILTER.ACTIONS_OPTIONS.BLOCKED_ATTEMPTED_LOGIN'
                ),
                value: 'blocked_attempted_login',
            },
            {
                label: this.translate.instant(
                    'SETTINGS_SECURITY.ACCESS_LOGS.FILTER.ACTIONS_OPTIONS.ATTEMPTS_EXCEEDED'
                ),
                value: 'attempts_exceeded',
            },
        ]);
    }
