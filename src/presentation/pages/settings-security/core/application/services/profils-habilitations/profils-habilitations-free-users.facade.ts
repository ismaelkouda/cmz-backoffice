...
export class ProfilsHabilitationsFreeUsersFacade extends BaseFacade<
    ProfilsHabilitationsFreeUsersEntity,
    null
> {
    private readonly uiFeedbackService = inject(UiFeedbackService);
    private readonly useCase = inject(ProfilsHabilitationsFreeUsersUseCase);
    ...
    assign(dto: ProfilsHabilitationsFreeUsersAssignDto) {
