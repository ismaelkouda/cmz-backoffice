...
export class DemandeShowComponent implements OnInit {
    ...
    public GetDetailTransaction() {
        this.supervisionOperationService
            .GetDetailTransaction({
                ...(this.router.url ===
                `/${SUPERVISION_OPERATIONS}/${NOTIFY_ROUTE}`
            ...
            .subscribe({
                next: (response) => {
                    ...
                    if (
                        ...
                        this.currentVolP =
                            this.detailTransaction?.detail_commande.filter(
                                (item) => {
    ...
    OnShowLigneForm() {
        ...
        this.ligneForm.disable();
        if (
            this.ligneForm.get('provisionning_accepte').value === 'non' ||
            this.ligneForm.get('provisionning_accepte').value === null
        ) {
    ...
    OnShowVolumeForm() {
        ...
        this.volumeForm.disable();
        if (
            this.volumeForm.get('volume_data_accepte').value === 'non' ||
            this.volumeForm.get('volume_data_accepte').value === null
        ) {
    ...
    OnShowSwapForm() {
        ...
        this.swapForm.disable();
        if (
            this.swapForm.get('swap_accepte').value === 'non' ||
            this.swapForm.get('swap_accepte').value === null
        ) {
    ...
    OnShowResiliationForm() {
        ...
        this.resiliationForm.disable();
        if (
            this.resiliationForm.get('resiliation_accepte').value === 'non' ||
            this.resiliationForm.get('resiliation_accepte').value === null
        ) {
    ...
    OnShowSuspensionForm() {
        ...
        this.suspensionForm.disable();
        if (
            this.suspensionForm.get('suspension_accepte').value === 'non' ||
            this.suspensionForm.get('suspension_accepte').value === null
        ) {
    ...
    OnShowActivationForm() {
        ...
        this.activationForm
            .get('niveau_1')
            .patchValue(this.detailTransaction?.niveau_uns_nom);
        this.activationForm
            .get('niveau_2')
            .patchValue(this.detailTransaction?.niveau_deux_nom);
        this.activationForm
            .get('niveau_3')
            .patchValue(this.detailTransaction?.niveau_trois_nom);
        this.activationForm
            .get('imsi')
            .patchValue(this.detailTransaction?.imsi);
        this.activationForm
        ...
        this.activationForm
            .get('usage')
            .patchValue(this.detailTransaction?.usage_nom);
        this.activationForm
            .get('point_emplacement')
            .patchValue(this.detailTransaction?.point_emplacement);
        this.activationForm
        ...
        this.activationForm.disable();
        if (
            this.activationForm.get('activation_accepte').value === 'non' ||
            this.activationForm.get('activation_accepte').value === null
        ) {
    ...
    OnShowAchatForm() {
        ...
        this.achatForm.disable();
        if (
            this.achatForm.get('commmande_produit_accepte').value === 'non' ||
            this.achatForm.get('commmande_produit_accepte').value === null
        ) {
