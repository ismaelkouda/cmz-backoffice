...
export class TableDetailsAchatProduits {
    ...
    constructor(public toastrService: ToastrService, private clipboardService: ClipboardService, private supervisionOperationService: SupervisionOperationService) { }
