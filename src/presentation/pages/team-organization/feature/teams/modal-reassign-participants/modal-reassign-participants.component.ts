...
export interface ReassignParticipantsFormInterface {
...
@Component({
    selector: 'app-modal-reassign-participants',
    standalone: true,
    templateUrl: './modal-reassign-participants.component.html',
    styleUrls: ['./modal-reassign-participants.component.scss'],
    imports: [
        CommonModule,
        ReactiveFormsModule,
        TranslateModule,
...
export class ModalReassignParticipantsComponent implements OnInit, OnDestroy {
    ...
    public formReassign!: FormGroup<ReassignParticipantsFormInterface>;
    ...
    private initForm(): void {
        this.formReassign = this.fb.group<ReassignParticipantsFormInterface>({
    ...
    private loadTeams(): void {
        this.teamOptions$ = this.teamFacade
            .getTeamsWithoutParticipant(this.teamId)
            .pipe(
                map((teams) =>
                    (teams || []).map((t) => ({
                        id: t.id,
