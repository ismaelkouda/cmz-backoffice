...
export class TableIndicatorsAlarmsComponent {
    ...
    @Input() listIndicatorsAlarms$: Observable<Array<indicatorsAlarmsInterface>>;
    ...
    public onExportExcel(): void {
        this.listIndicatorsAlarms$.subscribe(data => {
            if (data) { this.tableExportExcelFileService.exportAsExcelFile(data, this.table, "List_indicators"); }
        });
    }
