...
import { slaAgreementsApiResponseInterface, slaAgreementsInterface } from '../interfaces/sla-agreements.interface';

@Injectable()

export class SlaAgreementsApiService {    
    private slaAgreementsSubject = new BehaviorSubject<Array<slaAgreementsInterface>>([]);
    private slaAgreementsSelected = new BehaviorSubject<slaAgreementsInterface>({} as slaAgreementsInterface);
    private loadingSlaAgreementsSubject = new BehaviorSubject<boolean>(false);
    private apiResponseSlaAgreementsSubject = new BehaviorSubject<slaAgreementsApiResponseInterface>({} as slaAgreementsApiResponseInterface);
    ...
    fetchSlaAgreements(): void {
        ...
        const url: string = slaAgreementsEndpointEnum.SUPERVISION_OPERATIONS_ENGAGEMENTS_SLA_ALL;
