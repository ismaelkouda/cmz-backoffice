...
const etape_values = [
    MY_RELOADS_STATUS_ENUM.IN_PROGRESS,
    MY_RELOADS_STATUS_ENUM.VALIDATED,
    MY_RELOADS_STATUS_ENUM.REJECTED,
];
...
export class ReloadMyAccountComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.listReloadAccount$ =
            this.reloadMyAccountApiService.getReloadMyAccount();
        this.listReloadAccountResponse$ =
            this.reloadMyAccountApiService.getApiResponseReloadMyAccount();
        this.pagination$ =
            this.reloadMyAccountApiService.getReloadMyAccountPagination();
        this.reloadMyAccountApiService
            .getReloadMyAccountGlobalState()
                ...
                .subscribe((filterData: any) => {
                    switch (statisticBox.id) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            filterData.statut = MY_RELOADS_STATUS_ENUM.REJECTED;
                            break;
                        default:
                            return;
                    }
