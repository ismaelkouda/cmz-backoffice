...
import { T_MY_ACCOUNT_OPERATION_ENUM } from "../enums/my-account-operation.enum";
...
export interface myAccountInterface {
  ...
  created_at: string;
  updated_at: string;
  type: T_MY_ACCOUNT_OPERATION_ENUM;
}

export interface myAccountApiResponseInterface {
    error: boolean;
    message: string;
    data: Paginate<myAccountInterface>;
}
