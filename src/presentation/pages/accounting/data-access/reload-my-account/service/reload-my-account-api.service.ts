...
import {
    reloadMyAccountApiResponseInterface,
    reloadMyAccountGlobalStateInterface,
    reloadMyAccountInterface,
} from '../interfaces/reload-my-account.interface';
...
export class ReloadMyAccountApiService {
    ...
    private reloadMyAccountSubject = new BehaviorSubject<
        Array<reloadMyAccountInterface>
    >([]);
    private reloadMyAccountGlobalState =
        new BehaviorSubject<reloadMyAccountGlobalStateInterface>(
            {} as reloadMyAccountGlobalStateInterface
        );
    private reloadMyAccountPagination = new BehaviorSubject<
        Paginate<reloadMyAccountInterface>
    >({} as Paginate<reloadMyAccountInterface>);
    private reloadMyAccountSelected =
        new BehaviorSubject<reloadMyAccountInterface>(
            {} as reloadMyAccountInterface
        );
    private loadingReloadMyAccountSubject = new BehaviorSubject<boolean>(false);
    private dataFilterReloadMyAccountSubject =
        new BehaviorSubject<reloadMyAccountFilterInterface>(
            {} as reloadMyAccountFilterInterface
        );
    private dataNbrPageReloadMyAccountSubject = new BehaviorSubject<string>(
        '1'
    );
    private apiResponseReloadMyAccountSubject =
        new BehaviorSubject<reloadMyAccountApiResponseInterface>(
            {} as reloadMyAccountApiResponseInterface
        );

    fetchReloadMyAccount(
    ...
    getReloadMyAccountPagination(): Observable<
        Paginate<reloadMyAccountInterface>
    > {
    ...
    setReloadMyAccountSelected(
        reloadMyAccount: reloadMyAccountInterface
    ): void {
    ...
    private transactionDetailsSubject =
        new BehaviorSubject<ReloadAccountOperationDetailsInterface>(
            {} as ReloadAccountOperationDetailsInterface
        );
    private loadingTransactionDetailsSubject = new BehaviorSubject<boolean>(
        false
    );
    ...
    fetchTransactionDetails(transaction: string): void {
        ...
        this.httpClient
            ...
            .pipe(
                ...
                finalize(() =>
                    this.loadingTransactionDetailsSubject.next(false)
                )
            )
            .subscribe();
    }
    ...
    fetchDemandCredit(data: any): void {
        ...
        const url: string =
            reloadMyAccountEndpointEnum.MANAGEMENT_INVOICE_ACCOUNTS_STORE;
    ...
    private loadingUpdateDemandCreditSubject = new BehaviorSubject<boolean>(
        false
    );
    ...
    fetchUpdateDemandCredit(data: any): void {
        ...
        const url: string =
            reloadMyAccountEndpointEnum.MANAGEMENT_INVOICE_ACCOUNTS_UPDATE;
        ...
        this.httpClient
            ...
            .pipe(
                ...
                finalize(() =>
                    this.loadingUpdateDemandCreditSubject.next(false)
                )
            )
            .subscribe();
    }
    ...
    fetchLetDownCredit(data: any): void {
        ...
        const url: string =
            reloadMyAccountEndpointEnum.MANAGEMENT_INVOICE_ACCOUNTS_LETDOWN;
