...
export class StoreTokenService {
  ...
  private tokenSubject = new BehaviorSubject<TokenInterface | null>(this.getStoredToken());
  public token$: Observable<TokenInterface | null> = this.tokenSubject.asObservable();
