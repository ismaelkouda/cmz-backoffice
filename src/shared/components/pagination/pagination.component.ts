...
@Component({
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="pagination-wrapper">
                <p-paginator
                    ...
                    [first]="((pagination?.current_page - 1 || 0) *
                                    (pagination?.per_page || 0) + first +1) || 0"
                    [pageLinkSize]="9"
    ...
    styles: [`
        ...
        :host ::ng-deep .intuitive-paginator .p-paginator-first:hover::before,
        :host ::ng-deep .intuitive-paginator .p-paginator-prev:hover::before,
        :host ::ng-deep .intuitive-paginator .p-paginator-next:hover::before,
        ...
        :host ::ng-deep .intuitive-paginator .p-dropdown:not(.p-disabled).p-focus {
            border-color: #6366f1;
        ...
        :host ::ng-deep .intuitive-paginator .p-paginator-jump-to-page .p-inputtext {
            border: 1.5px solid #e2e8f0;
            border-radius: 10px;
        ...
        :host ::ng-deep .intuitive-paginator .p-paginator-jump-to-page .p-inputtext:hover {
            border-color: #94a3b8;
        }

        :host ::ng-deep .intuitive-paginator .p-paginator-jump-to-page .p-inputtext:focus {
            border-color: #6366f1;
            box-shadow: 0 0 0 3px rgba(99, 102, 241, 0.1);
        }
