...
export class InvoiceFormComponent {
    ...
    private getParamsInUrl(): void {
        ...
        this.urlParamNumeroDemande = this.activatedRoute.snapshot.paramMap.get('number_demand');
    ...
    public onDownloadPaymentReceipt() {
        this.detailsInvoiceForm?.["recu_paiement"] ? window.open(this.detailsInvoiceForm?.["recu_paiement"]) : this.toastrService.error("Aucun reçu de paiement disponible");
    }
    ...
    public initFormTypePaiement(): void {
        this.formTypePaiement = this.fb.group({
            numero_demande: this.createFormControl(this.detailsInvoiceForm?.["facture"]?.["numero_demande"], null, false),
            operation: this.createFormControl(this.detailsInvoiceForm?.["operation"], null, true),
            type_paiement: this.createFormControl(this.getNonNullValue(this.detailsInvoiceForm?.["type_paiement"]), Validators.required, false),
            recu_paiement: this.createFormControl(this.detailsInvoiceForm?.["recu_paiement"], null, false),
        });
