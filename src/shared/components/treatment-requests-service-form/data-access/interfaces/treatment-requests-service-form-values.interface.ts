...
export interface IAddTreatmentRequestsServiceFormValues {
    ...
    forme_juridique_code: FormControl<string>;
    ...
    commentaire_traitement: FormControl<string>;
    commentaire_finalisation: FormControl<string>;
    commentaire_approbation: FormControl<string>;

    accepte: FormControl<string>;
    notation_cloture: FormControl<string>;
