export interface TreatmentRequestsServiceDetailsResponseInterface {
    error: boolean;
    message: string;
    data: TreatmentRequestsServiceDetailsInterface;
}

export interface TreatmentRequestsServiceDetailsInterface {
