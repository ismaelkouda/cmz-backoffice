...
export class FilterHistoryComponent {
    ...
    constructor(private fb: FormBuilder, private toastService: ToastrService,
        private translate: TranslateService, private historyApiService: HistoryApiService) { }
    ...
    public initFormFilter(): void {
        this.historyApiService.getDataFilterHistory().subscribe(filterData => {
            this.formFilter = this.fb.group<historyFilterInterface>({
                ...
                user_id: new FormControl<number>(filterData?.["user_id"], { nonNullable: true }),
            });
        });
    }
