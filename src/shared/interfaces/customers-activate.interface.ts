...
export interface CustomersActivateInterface {
    id: number;
...
export interface CustomersActivateStatsInterface {
    ...
    data: Paginate<CustomersActivateInterface>;
}

export interface CustomersActivateApiResponseInterface {
    error: boolean;
    message: string;
    data: Paginate<CustomersActivateStatsInterface>;
}
