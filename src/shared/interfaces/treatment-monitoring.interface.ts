...
export interface TreatmentMonitoringInterface {
    id: number;
...
export interface TreatmentMonitoringStatsInterface {
    ...
    data: Paginate<TreatmentMonitoringInterface>;
}

export interface TreatmentMonitoringApiResponseInterface {
    error: boolean;
    message: string;
    data: Paginate<TreatmentMonitoringStatsInterface>;
}
